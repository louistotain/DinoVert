...
@section('content')
    ...
    <div id="background_QSN" class="container-fluid" style="height: 80vh;">
    ...
    <div class="container-fluid" style="background: white; color: #455D6A; height: 20vh;">
        <div class="row d-flex justify-content-center align-items-center h-100 w-100 m-auto">
            ...
            <div class="col-12 d-flex align-items-center justify-content-center svgAccueil" style="margin-top: -60px;">
                <div class="sc-qPMSF ATyBL">
                    <button type="button" title="Partager cette page sur Twitter"
                            aria-label="Partager cette page sur Twitter" class="sc-AxirZ gnuFZe sc-qXJKU cHKXqv"><span
                            class="sc-AxiKw cbpYqP"><svg height="15" width="15" viewBox="0 0 15 15"
                                                         xmlns="http://www.w3.org/2000/svg" fill="green" role="img"><path
                ...
                <div class="sc-qPMSF ATyBL">
                    <button type="button" title="Partager cette page sur Facebook"
                            aria-label="Partager cette page sur Facebook" class="sc-AxirZ gnuFZe sc-qXJKU cHKXqv"><span
                            class="sc-AxiKw cbpYqP"><svg height="15" width="15" viewBox="0 0 15 15"
                                                         xmlns="http://www.w3.org/2000/svg" fill="green" role="img"><path
                ...
                <div class="sc-qPMSF ATyBL">
                    <button type="button" title="Partager cette page sur Pinterest"
                            aria-label="Partager cette page sur Pinterest" class="sc-AxirZ gnuFZe sc-qXJKU cHKXqv"><span
                            class="sc-AxiKw cbpYqP"><svg height="15" width="15" viewBox="0 0 15 15"
                                                         xmlns="http://www.w3.org/2000/svg" fill="green" role="img"><path
                ...
                <div class="sc-qPMSF ATyBL">
                    <button type="button" title="Partager cette page sur LinkedIn"
                            aria-label="Partager cette page sur LinkedIn" class="sc-AxirZ gnuFZe sc-qXJKU cHKXqv"><span
                            class="sc-AxiKw cbpYqP"><svg height="15" width="15" viewBox="0 0 15 15"
                                                         xmlns="http://www.w3.org/2000/svg" fill="green" role="img"><path
                ...
                <div class="sc-oUAZN cmfQvt">
                    <button type="button" title="Ouvrir le panneau de partage pour partager cette page par e-mail"
                            aria-label="Ouvrir le panneau de partage pour partager cette page par e-mail"
                            class="sc-AxirZ gnuFZe sc-pcxSc iBMijp"><span class="sc-AxiKw cbpYqP"><svg height="11"
                                                                                                       width="11"
                                                                                                       viewBox="0 0 11 11"
                                                                                                       xmlns="http://www.w3.org/2000/svg"
                                                                                                       fill="green"
                                                                                                       role="img"><path
                                    d="m0 1.1h11l-5.5 4.2zm5.5 6.2-5.5-4.2v6.7h11v-6.7z"></path></svg></span></button>
                </div>
                <div class="sc-qPMSF ATyBL">
                    <button type="button" title="Voir plus de réseaux sociaux" aria-label="Voir plus de réseaux sociaux"
                            class="sc-AxirZ gnuFZe sc-qXJKU cHKXqv"><span class="sc-AxiKw cbpYqP"><svg height="15"
                                                                                                       width="15"
                                                                                                       viewBox="0 0 15 15"
                                                                                                       xmlns="http://www.w3.org/2000/svg"
                                                                                                       fill="green"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#background_QSN').click(function () {
                i++;
                if (i == 10) {
                    $('#background_QSN').addClass('background_tremble_QSN');
                    setTimeout(function () {
                        $('#background_QSN').removeClass('background_tremble_QSN');
                    }, 2000);
                    i = 0;
                }
            });
        ...
        $(document).ready(function () {
            ...
            $('nav.navbar').hover(function () {
                ...
                if (scroll == 0) {
                    ...
                    $('nav.navbar').removeClass('nav_accueil_display_none');
                ...
                if (scroll == 0) {
                    ...
                    $(this).addClass('nav_accueil_white_to_transparent');
                }
        ...
        $(window).scroll(function () {
            ...
            if (localStorage['scroll'] < scroll) {
                ...
                $('nav.navbar').addClass('nav_accueil_display_none');
            }
            ...
            if (scroll == 0) {
                ...
                $('nav.navbar').removeClass('nav_accueil_display_none');
                $('nav.navbar').removeClass('nav_accueil_white');
                $('nav.navbar').addClass('nav_accueil_white_to_transparent');
            }
